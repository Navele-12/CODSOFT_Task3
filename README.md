...
▫️Features: sepal length/width, petal length/width
▫️Model: Logistic Regression
▫️Evaluation: Accuracy score, classification report

Key Insights

▫️Petal measurements most discriminative
▫️Setosa perfectly separable from others
▫️Model generalizes perfectly
